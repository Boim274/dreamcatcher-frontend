  ...
  return (
    <div className="bg-white rounded-2xl shadow p-6">
      ...
      {loading ? (
        ...
        <div className="text-center">
          ...
          <div className="mt-4 flex gap-2 justify-center">
            ...
            {!usingCamera && (
              <button onClick={startCamera} className="inline-flex items-center gap-2 border-2 border-[#FF6B35] text-[#FF6B35] font-semibold py-2 px-4 rounded-lg hover:bg-[#FF6B35] hover:text-white transition-colors">
        ...
        <div className="text-center">
          ...
          <div className="mt-4 flex gap-2 justify-center">
            <button onClick={capturePhoto} className="bg-[#FF6B35] text-white font-semibold py-2 px-6 rounded-lg hover:bg-[#E55A26]">
        ...
        <div className="space-y-4">
          <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
            ...
            <label className="cursor-pointer">
              <input type="file" accept="image/*" onChange={handleImageUpload} className="hidden" />
              <span className="inline-flex items-center gap-2 bg-[#FF6B35] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#E55A26]">
                <Icon name="upload" size={20} /> Pilih Foto
              </span>
            </label>
          </div>
          <div className="text-center text-[#6B7280]">atau</div>
          <button onClick={startCamera} className="w-full inline-flex items-center justify-center gap-2 border-2 border-[#FF6B35] text-[#FF6B35] font-semibold py-3 rounded-lg hover:bg-[#FF6B35] hover:text-white transition-colors">
      ...
      <div className="flex gap-4 mt-6">
        ...
        <button onClick={nextStep} disabled={!mockupImage} className="flex items-center gap-2 flex-1 justify-center bg-[#FF6B35] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#E55A26] transition-colors disabled:opacity-50">
